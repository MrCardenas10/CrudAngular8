...
export const LOAD_EMPLOYEES_SUCCESS_CARGOS =
  "[Empleado] Try get empleados success cargos";
export const LOAD_EMPLOYEES_ERROR_CARGOS =
  "[Empleado] Try get empleados error cargos";
export const TRY_LOAD_EMPLOYEES_PROYECTOS =
  "[Empleado] Try get empleados proyectos";
export const LOAD_EMPLOYEES_SUCCESS_PROYECTOS =
  "[Empleado] Try get empleados success proyectos";
export const LOAD_EMPLOYEES_ERROR_PROYECTOS =
  "[Empleado] Try get empleados error proyectos";
