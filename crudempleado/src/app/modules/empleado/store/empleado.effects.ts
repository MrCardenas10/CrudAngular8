...
export class EmployeesEffects {
  ...
  getEmployees$ = this.actions$.pipe(
    ofType<EmpleadoActions.TryLoadEmployees>(
      EmpleadoActions.TRY_LOAD_EMPLOYEES
    ),
    switchMap(action => {
      return this.empleadoService.getUsers().pipe(
        map(res => {
  ...
  getEmployee$ = this.actions$.pipe(
    ...
    switchMap(action => {
      ...
      return this.empleadoService.getUser(id).pipe(
        map(res => {
  ...
  @Effect()
  getCargos$ = this.actions$.pipe(
    ofType<EmpleadoActions.TryLoadEmployeesCargos>(
      EmpleadoActions.TRY_LOAD_EMPLOYEES_CARGOS
    ),
    switchMap(action => {
      return this.empleadoService.getCargos().pipe(
        map(res => {
  ...
  @Effect()
  getProyectos$ = this.actions$.pipe(
    ofType<EmpleadoActions.TryLoadEmployeesProyectos>(
      EmpleadoActions.TRY_LOAD_EMPLOYEES_PROYECTOS
    ),
    switchMap(actions => {
      return this.empleadoService.getProyectos().pipe(
        map(res => {
  ...
  editEmployee$ = this.actions$.pipe(
    ...
    switchMap(action => {
      ...
      return this.empleadoService.updateUser(id, user).pipe(
        map(() => {
  ...
  addEmployees$ = this.actions$.pipe(
    ...
    switchMap(action => {
      ...
      return this.empleadoService.addUser(user).pipe(
        map(() => {
  ...
  deleteEmployee$ = this.actions$.pipe(
    ofType<EmpleadoActions.TryDeleteEmployee>(
      EmpleadoActions.TRY_DELETE_EMPLOYEE
    ),
    switchMap(action => {
      const id = action.payload;
      return this.empleadoService.deleteUser(id).pipe(
        map(() => {
